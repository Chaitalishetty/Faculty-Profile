<?php
    ...
    if(isset($_POST['revert'])){
        ...
        $sql = "UPDATE `copyright` SET `verified`='0', `v_comment`='".$_POST['v_comment']."' WHERE id='".$_POST['id']."' ";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            echo '
            <script type="text/javascript">
                alert("Copyright Reverted");
                window.open("../copyright.php", "_self");
            </script> 
        ';
        }else{
            echo '
    ...
    if(isset($_POST['verify'])){
        require "..\..\..\include\conn.php";
        $sql = "UPDATE `copyright` SET `verified`='2', `v_comment`='".$_POST['v_comment']."' WHERE id='".$_POST['id']."' ";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            echo '
            <script type="text/javascript">
                alert("Copyright Verified");
                window.open("../copyright.php", "_self");
            </script> 
        ';
        }else{
...
<html>
    ...
    <body>
        ...
        <br>
        <h3 style="margin:2%; text-align :center" id="headingh3"> Verify Copyright Records</h3>
        <div class="container">
            <div class="row">
                            ...
                            <div class="card-body" >
                                ...
                                <form name="frmUser" method="post" action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control col-lg-8 m-b-10"  value="<?php echo $row['copyright']; ?> "  name="copyright" readonly >
                                        ...
                                        <input type="text" class="form-control col-lg-8 m-b-10"  value="<?php echo $row['publisher']; ?>" name="publisher" readonly >
                                        
                                          <label class="col-lg-4">Ntnl/Intnl :</label>
                                        <input type="text" class="form-control col-lg-8 m-b-10"  value="<?php echo $row['ntnl']; ?>" name="ntnl" readonly >
                                          <label class="col-lg-4">Name of institute :</label>
                                        <input type="text" class="form-control col-lg-8 m-b-10"  value="<?php echo $row['institute']; ?>" name="institute"  readonly>
