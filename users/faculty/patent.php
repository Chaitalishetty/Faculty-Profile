...
$output.="</h5>";
 if(isset($_POST["gen_report"])){
  $i=0;
   ...
   $filter_query="";
  $select="SELECT * from patent where (sdrn = '$sdrn' OR faculty_name LIKE '%$faculty_name%' OR author1 LIKE '%$faculty_name%' OR author2 LIKE '%$faculty_name%' OR author3 LIKE '%$faculty_name%' OR author4 LIKE '%$faculty_name%')";
