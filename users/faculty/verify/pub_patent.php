<?php
    ...
    if(count($_POST)>0) {
        mysqli_query($conn,"UPDATE patent set id='". $_POST['id'] . "', author1='" . $_POST['author1'] ."', author2='" . $_POST['author2'] ."', 
        author3='" . $_POST['author3'] ."', author4='" . $_POST['author4'] ."', 
        designation='" . $_POST['designation'] ."', patent='" . $_POST['patent'] ."', 
        ...
        opt1='" . $_POST['opt1'] . "' ,opt2='" . $_POST['opt2'] . "' ,opt3='" . $_POST['opt3'] ."', verified='1' WHERE id='" . $_POST['id'] . "'");
...
<html>
    ...
    <body>
        ...
        <br>
        <h3 style="margin:2%; text-align :center" id="headingh3"> Update Patent Records</h3>
        <div class="container">
            <div class="row">
                            ...
                            <div class="card-body" >
                                ...
                                <form name="frmUser" method="post" action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control col-lg-8 m-b-10"  value="<?php echo $row['patent']; ?> "  name="patent" >
