...
<body>
  ...
  <div class="dashboard">
    ...
    <script>header();</script>
      ...
      <div class="chapter">
        <h1 class="text-center">Medical Exams</h1>
        ...
        <div style='width:90%;' >
            <table>
                <tr>
                <th>Sr No</th>
                <th >AIAGET Appered</th>
                <th >AIAGET Date</th>
                <th >AIAGET Score</th>
                <th >NEET-SS Appred</th>
                <th >NEET-SS Date</th>
                <th >NEET-SS Score</th>
                </tr>
                ...
                if(isset($_POST["gen_report"])){
                    if(isset($_POST["date_from"]) &&$_POST["date_to"] && $_POST["date_from"]!="" && $_POST["date_to"]!=""){
                        ...
                        $filter_query.="AND ((AIAPGET_Date between '$from' and '$to') OR (NEET_SS_Date between '$from' and '$to'))";
                    }
                }
                $s="select * from medicals where Sdrn='$sdrn' $filter_query  ";
                ...
                while($data=mysqli_fetch_array($result)){
                    ...
                    echo "<td>" . $srno . "</td>";
                    echo"
                    <td  style=' padding-left:10px;text-align: center;'>$sec</td>

                    <td  style=' padding-left:20px;text-align: center;'>$data[3]</td>
                    <td  style=' padding-left:20px;text-align: center;'>$data[4]</td>

                    <td  style=' padding-left:50px;text-align: center;'>$thi</td>

                    <td  style=' padding-left:50px;text-align: center;'>$data[6]</td>
                    <td  style=' padding-left:60px;text-align: center;'>$data[7]</td>";
