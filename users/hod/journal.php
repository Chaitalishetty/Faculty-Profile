...
$i=0;
$output="<h4>";
$sql =  "SELECT * from journal where sdrn IN (SELECT Sdrn FROM faculty WHERE Department='COMP')" ; 
...
$output.="</h4>";
 if(isset($_POST["gen_report"])){
  $i=0;
   ...
   $filter_query="";
  $select="SELECT * from journal where sdrn IN (SELECT Sdrn FROM faculty WHERE Department='COMP')";
