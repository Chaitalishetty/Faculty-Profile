            ...
            <div id="feedback">
             <!-- Heading Of The Form -->
                ...
                <form action="#" id="form" method="POST" name="form">
                    <input name="vname" placeholder="Your Name" type="text"  required>
                    <input name="vemail" placeholder="Email" type="text"  required>
                    <input name="sub" placeholder="Subject" type="text"  required>
