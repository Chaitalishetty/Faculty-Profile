...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            echo "<a href='$url'></a>"; 
        ?>
        <h2 class="text-center" style="margin-top:1%; margin-bottom: 2% ;" id="heading">Patent</h2>
                ...
                <div class="col-lg-8">
                    <div class="card" id="chapterCard">
                        ...
                        <form action="chapter.php" method="POST">
                            ...
                            <input type="date" class="form-control col-lg-8 m-b-10" name="reg_date" value=" " required>
                            <label class="col-lg-4"><span>*</span> Date of filing :</label>
                            <input type="date" class="form-control col-lg-8 m-b-10" autocomplete="off" value=" " placeholder="" name="patent" required>
                            ...
                            <textarea class= "form-control col-lg-8 m-b-10 " rows="3" autocomplete="off" value=" " placeholder="Enter option 1 here.." name="opt2"></textarea>
                            ...
                            <button type="submit" class="btn btn-primary col-lg-4 btn-lg m-t-10" id="submit" name="submit_patent">Submit</button>
                        </div>  
                    </form>
        ...
        <br>
            ...
            <!-- <div class="card" id="chapterCard"> -->
                <!-- <div class="card-body" >   -->
                    <div class="col-lg-4"></div>
                        <form action="../Details_show/show_patent.php" method="POST">
                            <button type="submit" class="btn btn-primary btn-lg btn-block" id="submit" name="show_patent" >Show Patent Records</button> 
                        </form>
                    </div>
                <!-- </div>     -->
            <!-- </div> -->
