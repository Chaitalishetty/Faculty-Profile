...
<html>
	...
	<body>
		...
		<div class="container " id="chapterCard">
			<h2 class="text-center" style="margin-top:3%; margin-bottom:5%">Upload Required Documents for Journals</h2>
			<div class="row">
				<div class="col-lg-2">
				</div>
				<div class="col-lg-8">				
...
<?php
	if ( isset( $_FILES['pdfFile'] ) ) {
		if ($_FILES['pdfFile']['type'] == "application/pdf") {
			...
			$dest_file = "../../../../Verification/documents/Journal/plag/".$_FILES['pdfFile']['name'];
...
<?php
	if ( isset( $_FILES['pdfFile1'] ) ) {
		if ($_FILES['pdfFile1']['type'] == "application/pdf") {
			...
			$dest_file = "../../../../Verification/documents/Journal/paper/".$_FILES['pdfFile1']['name'];
...
<?php
	if ( isset( $_FILES['pdfFile2'] ) ) {
		if ($_FILES['pdfFile2']['type'] == "application/pdf") {
			...
			$dest_file = "../../../../Verification/documents/Journal/fees/".$_FILES['pdfFile2']['name'];
...
<?php
	if ( isset( $_FILES['pdfFile3'] ) ) {
		if ($_FILES['pdfFile3']['type'] == "application/pdf") {
			...
			$dest_file = "../../../../Verification/documents/Journal/approval/".$_FILES['pdfFile3']['name'];
