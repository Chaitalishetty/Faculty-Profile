...
<html>
	...
	<body>
		...
		<div class="container " id="chapterCard">
			<h2 class="text-center" style="margin-top:3%; margin-bottom:5%">Upload Required Documents for Book Publications</h2>
            <div class="row">
                <div class="col-lg-2">
                </div>
                <div class="col-lg-8">
								...
								<table class="table">                               
									...
									<tbody>
										...
										<tr>
											...
											<td style="border:none"><input type="submit" id="pdf_submit" value="Upload Pdf" name="submit" ></td>                      
										</tr>
									</tbody>
								</table>
            				</div>   
...
<?php
	if ( isset( $_FILES['pdfFile'] ) ) {
		if ($_FILES['pdfFile']['type'] == "application/pdf") {
			...
			$dest_file = "../../../../Verification/documents/Book_publication/plag/".$_FILES['pdfFile']['name'];
...
if ( isset( $_FILES['pdfFile1'] ) ) {
	if ($_FILES['pdfFile1']['type'] == "application/pdf") {
		...
		$dest_file = "../../../../Verification/documents/Book_publication/paper/".$_FILES['pdfFile1']['name'];
...
if ( isset( $_FILES['pdfFile2'] ) ) {
	if ($_FILES['pdfFile2']['type'] == "application/pdf") {
		...
		$dest_file = "../../../../Verification/documents/Book_publication/fees/".$_FILES['pdfFile2']['name'];
...
if ( isset( $_FILES['pdfFile3'] ) ) {
	if ($_FILES['pdfFile3']['type'] == "application/pdf") {
		...
		$dest_file = "../../../../Verification/documents/Book_publication/approval/".$_FILES['pdfFile3']['name'];
