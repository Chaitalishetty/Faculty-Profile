...
<h3 id="heading"><center>Departmental Report</center></h3> 
      ...
      <button id="pdf_individual" style="margin-bottom:20px;" class="btn btn-success" onClick="createPdf()" name="pdf_individual">Convert to PDF</button>
      <button name="create_excel" style="margin-bottom:20px;" id="btnExport" class="btn btn-success">Create Excel File</button>
