...
<button type="submit" value="Submit" name="all_data" class="btn btn-success" >Submit</button>
<button type="submit" id="pdf_individual" onClick="createPdf()" class="btn btn-success" name="pdf_individual" value="Convert to PDF">
