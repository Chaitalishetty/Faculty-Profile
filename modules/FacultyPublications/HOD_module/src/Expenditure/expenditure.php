<!DOCTYPE html>
  ...
  <body>
    ...
    <div >
      <h3 style="margin-top : 20px"><center>Expenditure</center></h3><br>
      <div  style="margin:3%; padding: 20px" >
        <form method="post">
          ...
          <button type="submit" id="search" name="search_expenditure" class="btn btn-success" value="search" >Search</button>
          <button type="submit" id="pdf_expenditure" onClick="createPdf()" class="btn btn-success" name="pdf_expenditure" value="Convert to PDF" >Convert To PDF</button>
        ...
        <br><hr>
          ...
          <?php
            if(isset($_POST['search_expenditure'])){
...
////////////////////////////////////////////////////// Patent ////////////////////////////////////////////////////////////////
              ...
              <table class="table table-bordered" >  
                ...
                function expenditure_PatentData(){ 
                  $from=date('Y-m-d',strtotime($_POST['from']));
                  $to=date('Y-m-d',strtotime($_POST['to']));
                  echo "<p><b><center>Expenditure Details from date $from to $to are :</center></b></p>";
                  echo "<p>Patent </p>";
                  $output2 = '';  
...
////////////////////////////////////////////////////// Copyright ////////////////////////////////////////////////////////////////
                ...
                function expenditure_CopyrightData(){ 
                  $from=date('Y-m-d',strtotime($_POST['from']));
                  $to=date('Y-m-d',strtotime($_POST['to']));
                  echo "<p>Copyright </p>";
                  $output3 = '';  
                ...
                echo expenditure_CopyrightData();
                echo'</table></div><br>';
...
////////////////////////////////////////////////////// Journal ////////////////////////////////////////////////////////////////
                ...
                function expenditure_JournalData(){ 
                  $from=date('Y-m-d',strtotime($_POST['from']));
                  $to=date('Y-m-d',strtotime($_POST['to']));
                  echo "<p>Journal </p>";
                  $output4 = '';  
  ...
  ////////////////////////////////////////////////////// Conferences ////////////////////////////////////////////////////////////////
              ...
              function expenditure_ConferenceData(){ 
                  $from=date('Y-m-d',strtotime($_POST['from']));
                  $to=date('Y-m-d',strtotime($_POST['to']));
                  echo "<p>Conference </p>";
                  $output5 = '';  
              ...
              echo expenditure_ConferenceData();
              echo'</table></div><br>';
          }
        ?>
      </div>
  ...
  <script>
    function createPdf(){
      ...
      win.document.write('<title>Expenditure Details</title>');
