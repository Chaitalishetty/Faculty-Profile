...
<div style="margin:2%">
<h3 id="heading"><center>Departmental Report</center></h3> 

<div class="btn-group">
<button type="submit"  style="padding-top:20px; margin-bottom:20px; margin-bottom:20px;" id="pdf_individual"  onClick="createPdf()" name="pdf_individual" value="Convert to PDF">
Convert To PDF</button>
<button name="create_excel" style="padding-top:20px; margin-bottom:20px;" id="btnExport" >Create Excel File</button>

<form action="secure_email_form.php" method="POST">
<button type="submit" style="padding-top:20px; margin-left:10px;" id="sendmail" name="sendmail" value="sendmail">Send Email</button>
</form>
</div>
