...
$query = " SELECT * FROM syllabus WHERE Srno = '$ids' ";
...
<main>
  ...
  <head>
    ...
    <link rel="stylesheet" href="file:///C:/Users/Hp/Downloads/styles.css">
    <meta charset="utf-8">
  ...
  <body>
    <div>
      <form class="form-group" action="UpdateSyllabus2.php?id2=<?php echo $ids; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="formGroup">
          ...
          <input type="text" class="form-control" name="University" value="<?php echo $row['University']; ?>" required>
        </div>
        ...
        <div class="formGroup">
          ...
          <input list="all-collage" class="form-control" required id="venue" value="<?php echo $row['Venue']; ?>" name="Venue" onchange="changevenue()"><!-- data list of id all-collage is placed and end of body  -->
        </div>
