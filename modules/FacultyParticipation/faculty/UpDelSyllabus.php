          ...
          //      $NameOfFaculty = $_POST['NameOfFaculty'];
                ...
                while($row = mysqli_fetch_array($query_run))
                {
                    echo "<tr>"; 
                            ...
                            echo "<td>" . $row['Date'] . "</td>";
							echo "<td>". "<a href=UpdateSyllabus1.php?id=".$row['Srno'].">"."<img src='images/edit.png' style='width:20px'>"."</a>". "</td>";
							echo "<td>". "<a href=DeleteSyllabus.php?id=".$row['Srno'].">"."<img src='images/delete.png' style='width:20px'>"."</a>". "</td>";
                    echo "</tr>";
                    $srno++;
                }
            //}   
