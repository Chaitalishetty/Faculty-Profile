...
$sdrn=$user_check;
                ...
                $query = " SELECT * FROM workshop WHERE Srno = '$ids' ";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="formGroup"> 
      ...
      <input type="text" class="form-control" required name="Name of Seminar/Webinar" value="<?php echo $row['Name_workshop'];?>" placeholder="enter the name">

    </div>
    <div class="formGroup"> 
      <label class="event">Sponsorship received for event from:<span class="required">*</span></label>
      <input type="text" class="form-control"name="Sponsor received for event from" value="<?php echo $row['sponsor'];?>" required placeholder="enter the name">
    </div>
    <div class="formGroup"> 
      <label class="venue">Venue:<span class="required">*</span></label>
          <input list="all-collage" class="form-control" value="<?php echo $row['venue'];?>" required id="venue" name="Venue" onchange="changevenue()"><!-- data list of id all-collage is placed and end of body  -->
          <div id="new_venue_box" style="display: none;">
            <input type="text" name="new_venue" id ="new_venue" placeholder=" Enter venue name"  >
          </div>
          <script>
...
<option value = "Yadavrao Tasgaonkar Institute of Engineering & Technology (YTIET), Bhivpuri">
    ...
    <div class="formGroup"> 
      ...
      <input id="startDate"  class="form-control" type="date" value="<?php echo $row['sdate'];?>" required ata-date="" name="Date_From" data-date-format="DD/MM/YYYY" placeholder="DD/MM/YYYY" >
    </div>
    <div class="formGroup"> 
      <label for="To">To:</label>
      <input id="endDate"  class="form-control" type="date" required ata-date="" value="<?php echo $row['edate'];?>" name="Date_To" data-date-format="DD/MM/YYYY" placeholder="DD/MM/YYYY" onchange="cal()">
    </div>
    <div class="formGroup"> 
      <label class="days">No.of days:<span class="required">*</span></label>
      <input id="noOfDays" class="form-control" type="number" required name="Days" value="<?php echo $row['ndays'];?>" placeholder="enter the no.of days" style="width: 132px;">
    </div>
...
<div class="formGroup">   
  ...
  <input type="text" class="form-control" value="<?php echo $row['organiser'];?>" required name="Organiser" value="" placeholder="enter the name">
</div>
<div class="formGroup"> 
  <label class="choose">Level:<span class="required">*</span></label>
    <select id="Choose" class="form-control" required id="Choose" value="<?php echo $row['org_type'];?>" name="Local/State/National/International">
...
<div class="formGroup"> 
  <label class="Amount">Registration Amount:<span class="required">*</span></label>
    <input type="number"  class="form-control" required name="Registration Amount" value="<?php echo $row['ramount'];?>" placeholder="enter the amount">
</div>
<div class="formGroup"> 
    <label class="Amount">Amount funded:<span class="required">*</span></label>
   <input type="number" value="<?php echo $row['amount_funded'];?>" class="form-control" name="Amount funded" id="amt" value="" placeholder="enter the amount">
</div>
<div class="formGroup"> 
