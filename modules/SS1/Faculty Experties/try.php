...
<table id="tabledata5" class=" table table-striped table-hover table-bordered">
	<thead class="bg-dark text-white text-center">
		...
		<th>SDRN No.</th>
		<th>Faculty Name</th>		
		<th>AIAGET Appeared</th>
		<th>AIAGET Date</th>
		<th>AIAGET Scored</th>
		
	</thead>
	<?php 
	$sql="SELECT * FROM medicals WHERE AIAPGET_date BETWEEN '$a' and '$b'";
	$res=mysqli_query($conn,$sql);
	if(mysqli_num_rows($res)==0)
		{
			echo "<tr><td colspan='6' align='center'>No data for the Corresponding Date</td></tr>";
...
<table id="tabledata6" class=" table table-striped table-hover table-bordered">
	<thead class="bg-dark text-white text-center">
		...
		<th>SDRN No.</th>
		<th>Faculty Name</th>		
		<th>NEET-SS Appeared</th>
		<th>NEET-SS Date</th>
		<th>NEET-SS Scored</th>
		
	</thead>
	<?php 
	$sql="SELECT * FROM medicals WHERE NEET_SS_date BETWEEN '$a' and '$b'";
	$res=mysqli_query($conn,$sql);
	if(mysqli_num_rows($res)==0)
		{
			echo "<tr><td colspan='6' align='center'>No data for the Corresponding Date</td></tr>";
